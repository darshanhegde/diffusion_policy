...
from diffusion_policy.policy.leto_lowdim_policy import LetoLowdimPolicy
...
class TrainLetoLowdimWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: LetoLowdimPolicy = hydra.utils.instantiate(cfg.policy)
...
def main(cfg):
    workspace = TrainLetoLowdimWorkspace(cfg)
    workspace.run()
